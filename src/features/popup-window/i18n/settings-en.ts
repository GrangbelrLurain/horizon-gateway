export const settingsEn = {
  ...
  proxySaving: "Saving...",
  proxyLocalRoutingLabel: "Local routing",
  proxyLocalRoutingDesc: "Apply domain proxy routes to forward traffic to local targets.",
  proxyLocalRoutingOn: "On",
  proxyLocalRoutingOff: "Off",
